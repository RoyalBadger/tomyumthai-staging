...
export async function checkDeliveryZone(address, clientLat, clientLon, radiusMiles, { allowGoogle = true } = {}) {
  ...
  const d = await drivingMilesFromRestaurant(coords.lat, coords.lon, { allowGoogle });
  return {
